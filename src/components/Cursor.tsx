...
export const Cursor: React.FC<{ location: WindowLocation }> = ({
  ...
  const hoverEventListeners = () => {
    ...
    document.querySelectorAll(".trigger-hover").forEach((el) => {
      el.addEventListener("mouseenter", () => setHovered(true))
      el.addEventListener("mouseleave", () => setHovered(false))
    })
  }
  ...
  return (
    <>
      <div
        className="pointer-events-none fixed transform -translate-x-1/2 -translate-y-1/2 p-2 hidden sm:block bg-white rounded-full"
